...
#define IEEE802154_ATTR_ADF702X_POWER   (IEEE802154_TX_MODE_PRIV_START + 3)
#define IEEE802154_ATTR_ADF702X_RSSI    (IEEE802154_TX_MODE_PRIV_START + 4)
#define IEEE802154_ATTR_ADF702X_DUMP    (IEEE802154_TX_MODE_PRIV_START + 5)
